...
const createTemplateResto = (create) => `
    <div tabindex="0" class="card-item">
        <img tabindex="0" class="card-image" src="${CONFIG.BASE_IMAGE_URL}small/${create.pictureId}" alt="${create.name}" title="${create.name}">
...
}large/${create.pictureId}" alt="Restaurant ${create.name}">
        </div>
...
const createNoFavoriteTemplate = () => `
    <div class="empty-container">
        <img class="nodata" src="images/undraw_missed_chances_k-3-cq.svg">
